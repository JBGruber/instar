# Getting help with instar

Thanks for using instar. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/instar/issues) to make sure the 
